...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-slate-800 mb-4">
            ...
            <h1 class="text-slate-900 text-xl font-semibold tracking-tight">Quiz System</h1>
            <p class="text-slate-400 text-sm mt-1">Admin Portal</p>
        </div>

        {{-- Card --}}
        <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <h2 class="text-slate-800 text-[15px] font-semibold mb-5">Sign in to your account</h2>
